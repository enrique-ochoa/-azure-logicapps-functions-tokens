...
// If an Access Token has not been created or if it is about to expire
    ...
    // Acquire a new Access Token
                    ...
                    {
                        Console.WriteLine("Token used from cache, expires at " + CachedTokenExpiration);
                        output+="Token used from cache, expires at " + CachedTokenExpiration;
                    }
                    else
                    {
                        Console.WriteLine("Token acquired, expires at " + TimeZoneInfo.ConvertTimeFromUtc(result.ExpiresOn.DateTime, systemTimeZone));
